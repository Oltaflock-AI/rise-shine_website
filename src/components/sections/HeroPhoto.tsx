...
import type { HeroReviews } from "./Hero";

/**
 * BACKUP — not rendered anywhere. The original full-viewport photo-carousel
 * hero, retired 12-Sep-2026 when the client chose the OTA layout (`Hero.tsx`).
 * Kept on purpose so it can come back without digging through git history.
 */
export function HeroPhoto({ reviews }: { reviews?: HeroReviews }) {
