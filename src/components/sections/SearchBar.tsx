          ...
          <div className="mx-auto mb-3 flex w-fit gap-1 rounded-full bg-white/95 p-1.5 shadow-brand-sm backdrop-blur">
            {(
              ...
              <button
                ...
                className={cn(
                  "flex min-h-11 items-center gap-2 rounded-full px-5 py-2 text-[0.9rem] font-semibold transition-colors",
                  product === id
                ...
                <div className="flex items-center gap-1 border-b border-line px-5 pt-4">
                  ...
                  {(["oneway", "round"] as const).map((t) => (
                    <button
                      ...
                      onClick={() => setTrip(t)}
                      className={cn(
                        "min-h-11 rounded-t-lg px-4 py-2 text-[0.9rem] font-semibold transition-colors",
                        trip === t
                          ? "bg-red/10 text-red"
