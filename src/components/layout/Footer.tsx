...
const socials: { label: string; href: string; path: string; hidden?: boolean }[] = [
  {
    label: "Facebook",
  ...
  },
  {
    ...
    // Drops out of the row entirely while the mobile is not on WhatsApp.
    hidden: !whatsappEnabled,
  },
].filter((s) => !s.hidden);
