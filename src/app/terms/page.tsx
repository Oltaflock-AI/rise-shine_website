...
export const metadata: Metadata = {
  ...
  description:
    "The terms and conditions governing your use of the Rise & Shine Co website and services.",
...
export default function TermsPage() {
  return (
    <LegalPage
      ...
      title="Terms & Conditions"
      lastUpdated="16-07-2026 11:41:00"
      photoId="photo-1450101499163-c8848c66ca85"
    >
      <p>
        These Terms and Conditions, along with the privacy policy or other terms
        (&ldquo;Terms&rdquo;) constitute a binding agreement by and between RISE
        AND SHINE CO (&ldquo;Website Owner&rdquo; or &ldquo;we&rdquo; or
